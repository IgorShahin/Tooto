...
public class LinearActivity extends AppCompatActivity {
    ...
    public static Intent createStartIntent(Context context) {
        return new Intent(context, LinearActivity.class);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Profile profile = new Profile("Игорь", "Шахин", "Igor.Shahin22310@outlook.com",
                "gosha22310", "Саранск", 73153);
    ...
    void onClickExit() {
        Toast.makeText(LinearActivity.this, R.string.click_exit, Toast.LENGTH_SHORT).show();
    }

    @OnClick(R.id.buttonEditRegion)
    void onClickEditRegion() {
        Toast.makeText(LinearActivity.this, R.string.click_region, Toast.LENGTH_SHORT).show();
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menuProfile: {
                Toast.makeText(LinearActivity.this, R.string.click_menu, Toast.LENGTH_SHORT).show();
                return true;
            }
            default:
